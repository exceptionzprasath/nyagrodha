...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Made with love, wrapped in organic comfort. Premium 100% organic muslin cotton clothing for babies and kids. Made in India." },
      { name: "author", content: "Nyagrodha Apparels" },
